      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">
            shopa.app/<span className="font-medium text-brand-600">{profile.username}</span>
          </p>
        </div>

        {/* Premium Status */}
        {isPremium ? (
          <div className="bg-gradient-to-r from-brand-50 to-brand-100/50 border border-brand-200 rounded-xl p-4 mb-8">
            <div className="flex items-center gap-2">
              <span className="text-brand-600 font-semibold">Premium Active</span>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-4 mb-8 flex items-center justify-between">
            <div>
