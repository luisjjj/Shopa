        ...
        {isSuccess ? (
          ...
          >
            ...
            <h1 className="text-2xl font-bold mb-2" style={{ color: hasSettings ? textColor : undefined }}>
              {paid ? "Payment successful!" : "Transfer claimed!"}
            </h1>
            ...
            >
              <p className="text-xs uppercase tracking-wider font-medium" style={{ color: hasSettings ? `${textColor}50` : undefined }}>{paid ? "Amount paid" : "Amount to verify"}</p>
